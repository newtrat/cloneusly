...
**Tests**: The examples below include test tasks. Tests are OPTIONAL - only include them if explicitly requested in the feature specification. Every changed behavior still requires a proportionate automated or documented manual verification task.

**Organization**: Tasks are grouped by user story to enable independent implementation and testing of each story.

**Constitution-driven tasks**: For each story, include tasks that make the change
understandable to a collaborator and verify its behavior. When a change affects
setup, runtime configuration, build, startup, or rollback, include the corresponding
documentation and clean-checkout deployment validation. Record the justification for
each new dependency, abstraction, service, or infrastructure component.
...
- [ ] T004 [P] Document local setup, required environment variables, and build/run commands
...
- [ ] T010 Add example configuration and validate startup from a clean checkout
...
- [ ] T018 [US1] Document public behavior and non-obvious decisions for collaborator handoff
...
- [ ] TXXX [P] Update code, setup, configuration, and deployment documentation
- [ ] TXXX Code cleanup and refactoring
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX [P] Additional unit tests (if requested) in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Run formatter, linter, and relevant tests; document manual verification
- [ ] TXXX Validate documented build and startup from a clean checkout
